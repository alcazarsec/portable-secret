    ...
    export const buttonVariants = tv({
        ...
        variants: {
            variant: {
                ...
                outline:
                    'bg-transparent hover:bg-accent hover:text-accent-foreground dark:border-input dark:bg-input/30 dark:hover:bg-input/50 border shadow-2xs',
